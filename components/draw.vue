...
onMounted(()=>{
  ...
  setTimeout(()=>{
    ...
    L.drawLocal.draw.handlers.polygon.tooltip.end = 'برای تکمیل رسم شکل ، آن را به نقطه ابتدایی وصل کنید';
...
<template>
  <div style="height:100vh; width:100vw">
    ...
    <div class="fixed flex flex-row bottom-3 right-3  z-50 ">
      <div class="bg-green-400 text-white py-2 px-3 z-50 cursor-pointer" @click="doEnable"> Enable </div>
      <div class="bg-rose-400 text-white py-2 px-3 z-50 cursor-pointer" @click="doDisable"> Disable </div>
      <div class="bg-blue-400 text-white py-2 px-3 z-50 cursor-pointer" @click="doCreate"> Create Tools </div>
      <div class="bg-red-400 text-white py-2 px-3 cursor-pointer" @click="doDelete"> Delete Tools </div>
    </div>
